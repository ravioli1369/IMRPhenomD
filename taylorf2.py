...
def taylorf2_phase(
    ...
    pfa_v4 = 5.0 * (3058.673 / 7.056 + 5429.0 / 7.0 * eta + 617.0 * eta * eta) / 72.0
...
def taylorf2_amplitude(Mf: TensorType, mass1, mass2, eta, distance) -> TensorType:
...
def TaylorF2(
    ...
    htilde = taylorf2_htilde(f, mass1, mass2, chi1, chi2, distance, phic, f_ref)
